...
if __name__ == "__main__":
   with sqlite3.connect('database.db') as db:
    ...
    lineButton = Tk.Button(master=page3, text='View Bar Chart of Product Category over Product Brand Happiness', command=lambda:_barcata(cb2))
    lineButton.pack(side=Tk.TOP)
